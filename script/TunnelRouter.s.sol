...
contract DeployScript is Script {
    function run() external {
        ...
        address proxyVaultAddr = Upgrades.deployTransparentProxy(
            "Vault.sol", msg.sender, abi.encodeCall(Vault.initialize, (msg.sender, address(0x00), "laozi-mainnet"))
        );
        ...
        address proxyTunnelRouterAddr = Upgrades.deployTransparentProxy(
            ...
            abi.encodeCall(
                ...
                (tssVerifier, IVault(proxyVaultAddr), msg.sender, 100000, 300000, 0.11 gwei, "laozi-mainnet")
            )
        );
