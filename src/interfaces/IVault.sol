...
interface IVault {
     ...
     */
    event Deposited(uint256 indexed tunnelId, address indexed from, address indexed to, uint256 amount);
     ...
     */
    event Withdrawn(uint256 indexed tunnelId, address indexed from, address indexed to, uint256 amount);
