...
MSG=$(forge script script/DeployPacketConsumerTick.s.sol:Executor --rpc-url $RPC_URL --broadcast --private-key $PRIVATE_KEY --optimize true --optimizer-runs 200)
...
echo "================================================"
echo "PacketConsumerTick deployed at: $PACKET_CONSUMER" 
...
echo "========== Activating tunnel $TUNNEL_ID on target chain via PacketConsumerTick =========="
